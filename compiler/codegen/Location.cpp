...
int Location::getStartLineNum() const { return sLine; }
int Location::getStartColumnNum() const { return sCol; }
int Location::getEndLineNum() const { return eLine; }
int Location::getEndColumnNum() const { return eCol; }
