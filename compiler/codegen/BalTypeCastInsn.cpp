...
TypeCastInsn::TypeCastInsn(Operand *lOp, BasicBlock *currentBB, Operand *rOp, Type *tDecl, bool checkTypes)
    : NonTerminatorInsn(lOp, currentBB), rhsOp(rOp), typeDecl(tDecl), checkTypes(checkTypes) {}
