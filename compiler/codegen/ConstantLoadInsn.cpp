...
ConstantLoadInsn::ConstantLoadInsn(const Operand &lhs, std::weak_ptr<BasicBlock> currentBB, int intVal)
...
void ConstantLoadInsn::translate(LLVMModuleRef &modRef) {
    ...
    case TYPE_TAG_CHAR_STRING: {
        ...
        LLVMValueRef sizeOpValueRef[] = {valueRef, LLVMConstInt(LLVMInt32Type(), stringValue.length(), 0)};
