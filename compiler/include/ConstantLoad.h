...
class ConstantLoadInsn : public NonTerminatorInsn {
  ...
  public:
    ...
    ConstantLoadInsn(const Operand &lhs, std::shared_ptr<BasicBlock> currentBB, int64_t intVal);
    ConstantLoadInsn(const Operand &lhs, std::shared_ptr<BasicBlock> currentBB, double doubleVal);
